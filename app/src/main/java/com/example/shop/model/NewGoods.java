...
public class NewGoods implements Serializable{
        ...
        public NewGoods(int goodsId, int cateId, String goodsName, String goodsDisc, float goodsPrice, float goodsDiscount, int goodsStock, String goodsOrigin, String goodsMaterial, int goodsPostalfee, Date goodsDate, int goodsSales, String goodsPic) {
